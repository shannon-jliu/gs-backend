...
public class TargetSightingsDatabaseAccessor<T extends TargetSighting>
   ...
   * @return List<T> of all instances that have the same Target
   */
   ...
   * @return List<T> of all instances that were created by the assignment
   */
   ...
   * @return List<GpsLocation> of the GpsLocations for these sightings
   */
