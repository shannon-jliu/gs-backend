...
public class EmergentTargetSighting extends TargetSighting {
  ...
  @ManyToOne
  protected EmergentTarget target;
  ...
  public boolean equals(Object o) {
    ...
    if (!Objects.deepEquals(this.description, other.getDescription())) return false;

    return Objects.deepEquals(this.target, other.getTarget());
  }
}
