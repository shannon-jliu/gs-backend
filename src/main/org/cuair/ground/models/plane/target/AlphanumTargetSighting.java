...
public class AlphanumTargetSighting extends TargetSighting {
    ...
    @ManyToOne protected AlphanumTarget target;
    ...
    @JsonIgnore private Double adlcClassConf;
     ...
     * @param pixel_x Integer x pixel coordinate of the center of the target sighting in the specific
     *     Image
     * @param pixel_y Integer y pixel coordinate of the center of the target sighting in the specific
     *     Image
    ...
    public AlphanumTargetSighting(
            ...
            @JsonProperty("pixel_x") Integer pixel_x,
            @JsonProperty("pixel_y") Integer pixel_y,
    ...
    public void updateFromTargetSighting(TargetSighting other) {
        ...
        if (updateConf) updateAdlcClassConf();
    ...
    public boolean equals(Object o) {
        ...
        if (!Objects.deepEquals(this.alphaColorConfidence, other.getAlphaColorConfidence())) {
            return false;
        }
